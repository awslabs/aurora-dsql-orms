 ...
 *
 * <p>Extends PostgreSQL with DSQL-specific behavior: disables DDL transactions, uses inline PRIMARY
 * KEY constraints, and separates DDL from DML operations.
 */
