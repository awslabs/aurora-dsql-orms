 ...
 *
 * <p>These tests verify method signatures and return types. Basic override tests are in
...
class AuroraDSQLConnectionTest {
  ...
  void getSchemaReturnType() throws NoSuchMethodException {
    ...
    assertEquals(Schema.class, method.getReturnType(), "getSchema should return Schema");
  }
  ...
  void lockParameterTypes() throws NoSuchMethodException {
    Method method =
        AuroraDSQLConnection.class.getDeclaredMethod("lock", Table.class, Callable.class);
