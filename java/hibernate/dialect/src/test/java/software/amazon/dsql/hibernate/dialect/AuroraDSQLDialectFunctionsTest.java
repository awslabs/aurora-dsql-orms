...
public class AuroraDSQLDialectFunctionsTest {
  ...
  @Mock private SqlAppender appender;
  ...
  public void testTimestampaddPattern() {
    String pattern =
        dialect.timestampaddPattern(
            TemporalUnit.DAY, jakarta.persistence.TemporalType.TIMESTAMP, null);
    assertEquals("cast(?3+(?2)*interval '1 day' as timestamp)", pattern);

    pattern =
        dialect.timestampaddPattern(
            TemporalUnit.QUARTER, jakarta.persistence.TemporalType.DATE, null);
  ...
  public void testAppendDateTimeLiteral_TemporalAccessor() {
    ...
    dialect.appendDateTimeLiteral(
        appender, date, jakarta.persistence.TemporalType.DATE, TimeZone.getDefault());
    ...
    dialect.appendDateTimeLiteral(
        appender, time, jakarta.persistence.TemporalType.TIME, TimeZone.getDefault());
    ...
    OffsetDateTime timestamp =
        OffsetDateTime.of(LocalDateTime.of(2023, 5, 15, 14, 30, 45), ZoneOffset.UTC);
    dialect.appendDateTimeLiteral(
        appender, timestamp, jakarta.persistence.TemporalType.TIMESTAMP, TimeZone.getDefault());
  ...
  public void testAppendDateTimeLiteral_Date() {
    ...
    dialect.appendDateTimeLiteral(
        appender, date, jakarta.persistence.TemporalType.TIME, TimeZone.getDefault());
    ...
    dialect.appendDateTimeLiteral(
        appender, date, jakarta.persistence.TemporalType.TIMESTAMP, TimeZone.getDefault());
    verify(appender).appendSql("timestamp with time zone '");
    verify(appender).appendSql('\'');
  }
  ...
  public void testAppendDateTimeLiteral_Calendar() {
    ...
    dialect.appendDateTimeLiteral(
        appender, calendar, jakarta.persistence.TemporalType.DATE, TimeZone.getDefault());
    verify(appender).appendSql("date '");
    verify(appender).appendSql('\'');
    ...
    dialect.appendDateTimeLiteral(
        appender, calendar, jakarta.persistence.TemporalType.TIME, TimeZone.getDefault());
    verify(appender).appendSql("time with time zone '");
    verify(appender).appendSql('\'');
    ...
    dialect.appendDateTimeLiteral(
        appender, calendar, jakarta.persistence.TemporalType.TIMESTAMP, TimeZone.getDefault());
    verify(appender).appendSql("timestamp with time zone '");
    verify(appender).appendSql('\'');
  }
