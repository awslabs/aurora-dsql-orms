<a id="java/hibernate/v2.2.0"></a>
# [Aurora DSQL Dialect for Hibernate v2.2.0 (java/hibernate/v2.2.0)](https://github.com/awslabs/aurora-dsql-orms/releases/tag/java/hibernate/v2.2.0) - 2026-09-24

## What’s Changed

* Add native foreign-key support using `NOT VALID`, including constraint drops, cascade support, and Pet Clinic database-enforced relationships. Existing rows require separate asynchronous validation by [@davidrz15](https://github.com/davidrz15) in [#598](https://github.com/awslabs/aurora-dsql-orms/pull/598)
* Update `PESSIMISTIC_WRITE` support and guidance for inner joins and non-key predicates by [@mchenjh](https://github.com/mchenjh) in [#626](https://github.com/awslabs/aurora-dsql-orms/pull/626)
* Prevent Hibernate association columns from inheriting UUID defaults and repair integration coverage by [@amaksimo](https://github.com/amaksimo) in [#644](https://github.com/awslabs/aurora-dsql-orms/pull/644)

**Full Changelog**: https://github.com/awslabs/aurora-dsql-orms/compare/java/hibernate/v2.1.0...java/hibernate/v2.2.0

[Changes][java/hibernate/v2.2.0]
...
> **Note:** This release was originally published on Jul 03, 2025 by [@mitchell-elholm](https://github.com/mitchell-elholm) in [awslabs/aurora-dsql-hibernate](https://github.com/awslabs/aurora-dsql-hibernate/releases/tag/v1.0.0).
...
[java/hibernate/v2.2.0]: https://github.com/awslabs/aurora-dsql-orms/compare/java/hibernate/v1.0.1...java/hibernate/v2.2.0
